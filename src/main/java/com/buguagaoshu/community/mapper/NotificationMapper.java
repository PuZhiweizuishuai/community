...
public interface NotificationMapper {
     ...
     * @return 插入结果
     * */
    @Insert("insert into notification(notifier, receiver, outerId, commentId, commentContent, type, createTime, status)" +
            " values (#{notifier}, #{receiver}, #{outerId}, #{commentId}, #{commentContent}, #{type}, #{createTime}, #{status})")
